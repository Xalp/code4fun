...
"""
Block-based generation for Dream (without SMC).
This is the non-SMC version with KV-cache support.
"""
...
class DreamGenerationMixin:
    ...
    def _sample(
        ...
        for num_block in range(num_blocks):
            ...
            tps = block_length // i
            print(f"num_block: {num_block+1}, block length: {block_length}, diffusion steps: {i}, tokens/step: {tps}")
