...
\begin{table}[ht]
  ...
  \centering
    \begin{tabular}{l cccc}
      ...
      \midrule
      Pass@$N$ (upper bound) & 55.80 & 71.00 & 78.00 & 82.20 \\
      \midrule
      Majority Voting   & 37.60 & 43.20 & 43.40 & 45.00 \\
      Best-of-$N$       & 44.60 & 45.20 & 45.60 & 45.20 \\
      MCMC              & 44.20 & -- & -- & -- \\
      SR-SMC            & \textbf{45.40} & \textbf{47.00} & \textbf{46.40} & \textbf{47.40} \\
      \bottomrule
    \end{tabular}
\end{table}

\noindent\textbf{Key observations.} (1) SR-SMC consistently outperforms all compute-matched baselines across all scales. Even at $N=4$, SR-SMC (45.4\%) already surpasses BoN (44.6\%), MCMC (44.2\%), and Majority Voting (37.6\%), and this advantage is maintained as $N$ increases---reaching 47.4\% at $N=32$ vs.\ BoN's 45.2\% and MajVote's 45.0\%. (2) Majority Voting scales slowly on MATH---from 37.6\% at $N=4$ to 45.0\% at $N=32$---consistent with the high answer disagreement rate (42.2\% of questions have all answers different, as shown in Table~\ref{tab:vote_analysis}). Despite scaling, MajVote never catches up to SR-SMC. (3) Best-of-$N$ saturates quickly: performance plateaus around 45\% from $N=4$ to $N=32$, suggesting that the model's self-scoring signal alone is insufficient for further improvement. (4) The oracle Pass@$N$ grows substantially (55.8\% $\rightarrow$ 82.2\%), indicating that correct solutions \emph{exist} among the particles but the challenge is \emph{selection}. SR-SMC's resampling mechanism addresses this gap most effectively by pruning low-quality trajectories \emph{during} generation rather than \emph{after}.
